/* NM: Cart script */
(function(a){a.extend(a.nmTheme,{cart_init:function(){var b=this;b.quantityInputsBindButtons(a(".woocommerce"));b.$body.on("added_to_cart",function(){a("#nm-quickview").is(":visible")&&b.cartTriggerUpdate()});a("#nm-coupon-btn").on("click",function(c){c.preventDefault();a(this).next(".nm-coupon").slideToggle(300)});a("#nm-apply-coupon-btn").on("click",function(c){c.preventDefault();if((c=a("#nm-coupon-code").val())&&0<c.length){var d=a("#coupon_code");d.val(c);d.next(".button").trigger("click");setTimeout(function(){a("html, body").animate({scrollTop:0},
